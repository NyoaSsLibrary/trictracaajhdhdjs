	...
	if bp then
		for _,t in ipairs(bp:GetChildren()) do
			if t:IsA("Tool") and (t.Name:lower():find("bat") or t.Name:lower():find("slap")) then
				local hum = char:FindFirstChildOfClass("Humanoid")
				if hum then pcall(function() hum:EquipTool(t) end) else t.Parent = char end
				return t
			end
		end
	end
...
local function buildGui()
	...
	-- Fill inner corners where contentArea meets the sidebar (top-left and bottom-left)
	local innerCornerTop = Instance.new("Frame", main)
	innerCornerTop.Size = UDim2.new(0, 28, 0, 28)
	innerCornerTop.Position = UDim2.new(0, (SIDEBAR_W - CONTENT_OVERLAP) + MENU_GAP, 0, 0)
	innerCornerTop.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
	innerCornerTop.BorderSizePixel = 0
	innerCornerTop.ZIndex = 3
	local innerCornerBot = Instance.new("Frame", main)
	innerCornerBot.Size = UDim2.new(0, 28, 0, 28)
	innerCornerBot.Position = UDim2.new(0, (SIDEBAR_W - CONTENT_OVERLAP) + MENU_GAP, 1, -28)
	innerCornerBot.BackgroundColor3 = Color3.fromRGB(18, 18, 18)
	innerCornerBot.BorderSizePixel = 0
	innerCornerBot.ZIndex = 3
	...
	pbDiv.Size = UDim2.new(0, 1, 1, -8)
	pbDiv.Position = UDim2.new(0, 184, 0, 4)
